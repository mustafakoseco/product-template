...
let toastArea = document.querySelector("#cartToast");
function swiperLoad() {
  const mainSwiper = new Swiper(".customSwiper", {
    lazy: {
      loadPrevNext: true,
  ...
  toastHTML += `<div class="toast-body toastCard">
                  <section>
                      ...
                      <div class="toastText">
                          ...
                          <a target="_blank" href="/cart"> Sepete Git</a>
                      </div>
                  </section>
